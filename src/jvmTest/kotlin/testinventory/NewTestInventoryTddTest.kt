...
class NewTestInventoryTddTest {
    ...
    fun strategyDocumentTracksBaselineInventoryAndFixtureScope() {
        ...
        assertTrue(strategy.contains("| **Total current inventory** | Common + JVM | **229** | **1715** |"))
        assertTrue(strategy.contains("current_campaign_files = 173"))
        assertTrue(strategy.contains("current_campaign_total = 1277"))
    ...
    private companion object {
        ...
        const val expectedBaselineFiles = 229
        const val expectedBaselineTestMethods = 1715
        const val expectedCampaignFiles = 173
        const val expectedCampaignTestMethods = 1277
