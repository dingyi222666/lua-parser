...
internal object Lua53BuiltinOverlaySources {
    ...
    val globalNames: Set<String> = linkedSetOf(
        "_G", "_VERSION", "assert", "bit32", "collectgarbage", "coroutine", "debug", "error",
        "io", "ipairs", "math", "next", "os", "package", "pairs", "pcall", "print", "rawequal",
