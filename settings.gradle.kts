pluginManagement {
    ...
    // applies these plugins WITHOUT versions). AGP 8.5.2: first stable line
    // with first-class compileSdk 34 support, needs Gradle >= 8.7 (wrapper is
    // 8.14.4) and JDK 17 to run Gradle — all satisfied here; Kotlin Android
